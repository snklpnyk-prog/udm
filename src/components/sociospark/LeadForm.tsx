...
export default function LeadForm({ defaultRequirement = "Website", compact = false }: LeadFormProps) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-brand text-brand-foreground border-2 border-black rounded-xl px-6 py-4 text-lg font-black brutalist-shadow hover:-translate-y-0.5 transition-transform disabled:opacity-60"
      >
